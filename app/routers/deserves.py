...
from ..db.models import DeservesContest, DeservesCandidate
...
async def show_deserves_results(cb: CallbackQuery) -> None:
    ...
    await cb.message.edit_text(text, reply_markup=deserves_controls_kb(contest_id, contest.is_active))
    await cb.answer()